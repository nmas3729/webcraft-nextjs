...
export const metadata: Metadata = {
  title: 'Website Design from R899 per month | NMAS WebCraft',
  description: 'Custom Next.js websites for South African businesses. Pay nothing until live. No contracts. From R899 per month.',
